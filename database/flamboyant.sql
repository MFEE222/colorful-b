...
--
-- Host: localhost
-- Generation Time: Feb 23, 2022 at 12:05 PM
...
INSERT INTO `users` (`id`, `name`, `gender`, `account`, `email`, `password`, `phone`, `birthday`, `created_at`, `modified_at`, `registered`, `password_hint`, `user_status_id`) VALUES
